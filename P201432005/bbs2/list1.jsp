...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*, java.net.*, lecture1.*,java.text.*"%>
	...
	<div class="container">
		...
		<form class="form-inline">
			<div class="form-group">
				<label>정렬</label> <select name="od" class="form-control">
					<option value="0" <%="0".equals(od) ? "selected" : ""%>>등록순서</option>
					<option value="1" <%="1".equals(od) ? "selected" : ""%>>작성자
						오름차순</option>
					<option value="2" <%="2".equals(od) ? "selected" : ""%>>작성자
						내림차순</option>
					<option value="3" <%="3".equals(od) ? "selected" : ""%>>최신글순서</option>
					<option value="4" <%="4".equals(od) ? "selected" : ""%>>제목
						오름차순</option>
				</select> <select name="ss" class="form-control">
		...
		<my:pagination pageSize="<%=pageSize%>" recordCount="<%=recordCount%>"
			queryStringName="pg" />
